  ...
  <Combobox v-model="selected">
    <div class="w-full relative">
      ...
      <TransitionRoot
        ...
        @after-leave="query = ''"
      >
        <ComboboxOptions class="absolute mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-sm ring-1 ring-inset ring-gray-200 focus:outline-none sm:text-sm">
          <div
